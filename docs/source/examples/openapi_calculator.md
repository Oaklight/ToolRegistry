# Example Makde and Use of Calculator OpenAPI Tool
...
We implement using both OpenAI client and Cicada `MultiModalModel` to showcase different ways to integrate with the tool registry.
