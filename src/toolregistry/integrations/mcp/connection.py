...
class MCPConnectionManager:
    ...
    def call_tool_sync(self, name: str, arguments: dict[str, Any]) -> CallToolResult:
        """Call a tool synchronously using the shared AsyncRuntime loop.

        The shared daemon thread keeps MCP transport resources alive
        across calls.
    ...
    def close_sync(self) -> None:
        """Close from sync context using the shared AsyncRuntime."""
        from ..._async_runtime import AsyncRuntime
