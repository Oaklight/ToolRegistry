...
async def async_register():
    await openapi_registry.register_openapi_tools_async(openapi_spec_url)
...
mcp_registry.register_mcp_tools(mcp_server_url)
pprint(mcp_registry)
